...
public class ManageTransaksiBeli extends Database{
    ...
    private enum TRB{
        ID_TR_BELI, NAMA_TR_BELI, ID_KARYAWAN, ID_SUPPLIER, ID_BARANG, 
...
//    };
    ...
    public boolean validateAddTransaksiBeli(String idTrj, String namaTrJual, String idKaryawan, String idSupplier, String idBarang, String jmlBrg, String ttlHarga, String tanggal){
        ...
        return vIdTrj && vNamaTrJual && vIdPetugas && vIdSupplier && vIdBarang && vJmlBrg && vTtlHarga && vTanggal;
    }
    ...
    public String getIdPetugas(String idTrj){
        return this.getData(idTrj, TRB.ID_KARYAWAN);
    }
    ...
    public boolean setIdPetugas(String idTrj, String newValue){
        return this.setData(idTrj, TRB.ID_KARYAWAN, newValue);
    }
...
//        );
        ...
        boolean isSuccess = tr.addTransaksiBeli("sok tau", "PG004", "SP123", "BG011", "9", "15000", "2022-10-20");
