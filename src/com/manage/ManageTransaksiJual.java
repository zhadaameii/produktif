...
public class ManageTransaksiJual extends Database{
    ...
    private enum TRJ{
        ID_TR_JUAL, NAMA_TR_JUAl, ID_KARYAWAN, ID_PEMBELI, ID_BARANG, 
    ...
    public boolean addTransaksiJual(String namaTrJual, String idPetugas, String idPembeli, String idBarang, String jmlBrg, String ttlHarga, String tanggal){
        ...
        try {
            ...
            if(this.validateAddTransaksiJual(idTrj, namaTrJual, idPetugas, idPembeli, idBarang, jmlBrg,  ttlHarga, tanggal)){
                ...
                pst = this.conn.prepareStatement("INSERT INTO transaksi_jual(`id_tr_jual`, `nama_tr_jual`, `id_karyawan`, `id_pembeli`, `id_barang`, `jumlah_brg`, `total_hrg`, `tanggal`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
//        }
    ...
    public String getIdPetugas(String idTrj){
        return this.getData(idTrj, TRJ.ID_KARYAWAN);
    }
    ...
    public boolean setIdPetugas(String idTrj, String newValue){
        return this.setData(idTrj, TRJ.ID_KARYAWAN, newValue);
    }
